...
const CantidadEquipos = () => {
    ...
    const redirectToNextPage = () => {
        ...
        navigation.navigate('ConfiguracionSorteo', { equipos: equiposString });
    };

    return (
        <View style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollView}>
                <Text style={styles.title}>Fase de Grupos: Configuración de Equipos</Text>
                <Text style={styles.subtitle}>¡Bienvenido a la fase de grupos de tu sorteo! En esta etapa, podrás definir la cantidad de equipos que participarán en el sorteo.</Text>
                ...
                <Text style={styles.exampleText}>Si ingresas "8", el sistema organizará un sorteo para 8 equipos, dividiéndolos en grupos de manera aleatoria.</Text>
...
export default CantidadEquipos;