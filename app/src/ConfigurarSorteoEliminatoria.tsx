...
const ConfiguracionSorteoEliminatoria = () => {
  ...
  const sorteoFinal = () => {
    if (seleccionarPartido === '') {
      ...
      navigation.navigate('SorteoFinalEliminatoria', {
        equipos: equiposString,
        seleccionarPartido: seleccionarPartido,
      });
    }
  };
  ...
  return (
    <ScrollView style={styles.container}>
            <Text style={styles.title}>Configuración de Sorteo Eliminatoria</Text>
...
export default ConfiguracionSorteoEliminatoria;