...
import { View, Text, Button, FlatList, Modal, StyleSheet, ScrollView, TextInput, TouchableOpacity } from 'react-native';  
import { useNavigation, useRoute } from '@react-navigation/native';  
import { Equipo } from '../equipo';

const SorteoFinalLiguillaComponent = () => {  
    ...
    const completarPartido = async (grupoIndex, partidoIndex) => {  
        if (golesTemporales[`${grupoIndex}-${partidoIndex}`] === undefined) {  
            ...
            if (equipo1 && equipo2) {  
                ...
                if (i < cantidadJornada.length - 1) {  
                    ...
                    equipoGanador.current = await getNombrePrimerEquipo()
                    toggleModal()
                    setI(0)
                }  
            }  
    ...
    const getNombrePrimerEquipo = () => {
        let primerEquipo = null;
    
        for (const grupo of equiposPorGrupo) {
          ...
          >  
            <View style={styles.modalOverlay}>  
              <View style={styles.modalContent}>  
                ...
                <Text>¡Felicidades {equipoGanador.current}, eres el campeón del torneo!</Text>  
...
export default SorteoFinalLiguillaComponent;